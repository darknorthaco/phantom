...
class TestSystemScanAdapter(unittest.TestCase):
    ...
    def test_check_values_have_required_fields(self):
        ...
        for key, info in result["checks"].items():
            ...
            self.assertIn(info["status"], ("ok", "warning", "fail", "unknown"),
...
class TestWorkerDiscoveryAdapter(unittest.TestCase):
    ...
    def test_enrich_adds_display_fields(self):
        raw = [{"ip": "10.0.0.1", "gpu": "RTX 3090", "memory_total": 24576, "available": True}]
...
class TestModelDownloader(unittest.TestCase):
    ...
    def test_models_catalogue_structure(self):
        ...
        for m in MODELS:
            for field in ("id", "name", "filename", "url", "vram_min_gb",
                          "vram_rec_gb", "file_size_gb"):
    ...
    def test_download_raises_on_failure(self):
        ...
        try:
            ...
            with patch.object(dl, "_download_file", side_effect=ConnectionError("refused")):
...
class TestConfigWriter(unittest.TestCase):
    ...
    def test_write_worker_registry(self):
        ...
        task_master = {
            ...
            "hostname": "master-node", "gpu_name": "RTX 5080",
            "vram_total_mb": 16_384, "health": "Healthy",
        }
        workers = [task_master, {
            "ip": "192.168.1.11", "port": 8090,
            "hostname": "worker-1", "gpu_name": "GTX 1080",
            "vram_total_mb": 8_192, "health": "Healthy",
        }]
