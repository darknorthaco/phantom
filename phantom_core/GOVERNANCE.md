# Phantom_PTR Governance

**Version:** 1.0.0  
**Repository:** darknorthaco/phantom_ptr  
**Type:** Public Sandbox  
**Status:** Active
...
This document defines the governance model for the Phantom_PTR public sandbox repository. It establishes decision-making processes, contribution guidelines, and enforcement mechanisms to ensure alignment with the Phantom Ethos, Ten Commandments, and Soul of Phantom.
...
The [Ten Commandments](./PHANTOM_COMMANDMENTS.md) provide concrete operational rules derived from the Ethos.
...
**Examples:**
- [GITPRO_ANALYSIS_MODE.md](./GITPRO_ANALYSIS_MODE.md) - Analysis-only operations
...
### Phantom_PTR vs. Private Phantom

**Phantom_PTR (This Repository):**
- **Public sandbox** for experimentation and community engagement
- **Analysis-first** approach to changes
- **Open contributions** within governance boundaries
- **NOT authoritative** for production Phantom systems

**Private Phantom Repository:**
- **Production codebase** for Phantom Distributed
- **Closed access** with strict controls
- **Enterprise-grade** quality and security requirements
- **Authoritative source** for production deployments

**Critical Rule:** Changes in Phantom_PTR do NOT automatically apply to private Phantom. The two repositories are **separate and independent**.
...
5. **Respect Sandbox Boundary**
   - Work only in Phantom_PTR
   - Do not reference private Phantom repo
...
- No proprietary material included
...
Governance in Phantom_PTR is designed to:
...
By following these guidelines, we build a productive, principled, and collaborative environment for exploring Phantom's distributed compute platform.
